# Generated by Django 4.1.8 on 2025-05-24 19:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.SmallIntegerField(blank=True, choices=[(0, '未知'), (1, '女'), (2, '男')], help_text='性别', null=True, verbose_name='性别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(default=True, help_text='角色状态', verbose_name='角色状态')),
                ('data_scope', models.SmallIntegerField(choices=[(0, '仅本人数据权限'), (1, '本部门数据权限'), (2, '本部门及以下数据权限'), (3, '自定义部门数据权限'), (4, '全部数据权限'), (5, '自定义数据权限')], default=3, help_text='数据权限范围', verbose_name='数据权限范围')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('menu', models.ForeignKey(db_constraint=False, help_text='关联菜单', on_delete=django.db.models.deletion.CASCADE, related_name='menu_permissions', to='mysystem.menu', verbose_name='关联菜单')),
                ('role', models.ForeignKey(db_constraint=False, help_text='关联角色', on_delete=django.db.models.deletion.CASCADE, related_name='role_permissions', to='mysystem.role', verbose_name='关联角色')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('data_scope', models.SmallIntegerField(choices=[(0, '仅本人数据权限'), (1, '本部门数据权限'), (2, '本部门及以下数据权限'), (3, '自定义部门数据权限'), (4, '全部数据权限'), (5, '自定义数据权限')], default=3, help_text='数据权限', verbose_name='数据权限')),
                ...
                ('role', models.ForeignKey(db_constraint=False, help_text='关联角色', on_delete=django.db.models.deletion.CASCADE, related_name='role_menu_button', to='mysystem.role', verbose_name='关联角色')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('model', models.CharField(blank=True, max_length=70, null=True, verbose_name='表名')),
                ('field_name', models.CharField(max_length=64, verbose_name='模型表字段名')),
                ('title', models.CharField(max_length=64, verbose_name='字段显示名')),
                ('menu', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='mysystem.menu', verbose_name='关联菜单')),
            ],
            options={
                'verbose_name': '菜单字段表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='menu_field', to='mysystem.menufield', verbose_name='字段')),
                ('role', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='mysystem.role', verbose_name='关联角色')),
            ],
            options={
                'verbose_name': '字段权限表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(db_constraint=False, help_text='创建人', null=True, on_delete=django.db.models.deletion.SET_NULL, related_query_name='creator_query', to=settings.AUTH_USER_MODEL, verbose_name='创建人')),
                ('parent', models.ForeignKey(blank=True, db_constraint=False, help_text='父级', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='subdicts', to='mysystem.dictionary', verbose_name='父级')),
            ],
            options={
                'verbose_name': '字典表',
