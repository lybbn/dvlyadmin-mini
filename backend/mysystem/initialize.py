...
class Initialize:
    ...
    def init_menu(self):
        ...
        self.menu_data = [
            ...
            {'id': 'af862854dc44410d84b8b2ae5c16c90d', 'name': '系统管理','icon': 'Setting', 'sort': 40, 'web_path': '/dirsettings', 'parent_id': None, 'component': None, 'component_name': None, 'visible': 1,'cache': 0, 'isautopm': 0,'type': 0},
